...
import 'package:cafit/common/widgets/tip_row.dart';
import 'package:cafit/controllers/tips_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
            onPressed: () {
              TipsController().navigateToBack(context);
            },
            icon: Image.asset(
      ...
      body: ListView.separated(
          ...
          itemBuilder: (context, index) {
            var tObj = TipsController.tipsArr[index] as Map? ?? {};
            return TipRow(
              tObj: tObj,
              isActive: index == 0,
              onPressed: () {
                TipsController().navigateToTipsDetailePage(context, tObj);
              },
            );
          },
          ...
          itemCount: TipsController.tipsArr.length),
